...
public abstract class AnvilScreenHandlerMixin extends ItemCombinerMenu {
    ...
    @ModifyArg(method = "createResult", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/inventory/ResultContainer;setItem(ILnet/minecraft/world/item/ItemStack;)V",ordinal = 4))//neoforge:3
